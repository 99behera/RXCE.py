...
def hero():
    ...
    y=1
    newperiod=period
    banner='figlet ESMER|lolcat'
    numbers=[]
    while(y):
        clear()
        system(banner)
        print(f"{red}Contact me on telegram @RXCE_LOVER")
        print(f"{yellow}Enter ",newperiod," Sapre Price :")
        current=input()
        current=int(current)
        chalo()
...
if(expirydate>today):
    ...
    while(True):
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("1st-30th APR 2022, 02:30 PM- 03:00 PM")
            print("1st-30th APR 2022, 05:30 PM- 06:00 PM")
            print("1st-30th APR 2022, 08:30 PM- 09:00 PM")
            print("Please play on the given time, and ")
            ...
            system(banner)
            print("----------Your play time-----------")
            print("9th-8th MAY 2022, 02:30 PM- 03:00 PM")
            print("9th-8th MAY 2022, 06:00 PM- 06:30 PM")
            print("9th-8th MAY 2022, 08:30 PM- 09:00 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
